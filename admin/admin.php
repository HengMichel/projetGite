...
<div class="container d-flex justify-content-around border border-3 border-warning" >
    ...
    <div class="card mt-5 m-3 w-25 border-warning border-3" style="width: 18rem;">
      ...
      <div class="card-body bg-success link-warning">
        ...
        <a href="add_room.php" class="btn btn-primary bg-warning border-2 border-warning fw-medium mx-lg-5 mt-2 link-dark">Ajouter une chambre</a>
      </div>
    </div>
    <div class="card mt-5 m-3 w-25 border-warning border-2" style="width: 18rem;">
      ...
      <div class="card-body bg-success link-warning">
        ...
        <a href="#" class="btn btn-primary bg-warning  border-2 border-warning fw-medium mx-lg-5 mt-2 link-dark">Liste réservation</a>
      </div>
    </div>
    ...
    <div class="card mt-5 m-3 w-25 border-warning border-2" style="width: 18rem;">
      ...
      <div class="card-body bg-success link-warning">
        ...
        <a href="room_list.php" class="btn btn-primary bg-warning border-2 border-warning fw-medium mx-lg-5 mt-2 link-dark">Liste chambre</a>
      </div>
    </div>
</div>
