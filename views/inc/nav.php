...
<nav class="navbar navbar-expand-lg mb-5">
        <div class="container-fluid  link-warning">
            <a class="navbar-brand link-warning" href="http://localhost/projetGite/views/accueil.php">Accueil</a>
            ...
            <div class="collapse navbar-collapse d-flex justify-content-end" id="navbarText">
                <ul class="navbar-nav mb-2 mb-lg-0 link-warning ">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active link-warning" aria-current="page" href="http://localhost/projetGite/views/add_chambre.php">Ajouter une chambre</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link link-warning" href="http://localhost/projetGite/views/list_chambre.php">Liste des chambres</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link link-warning" href="http://localhost/projetGite/views/inscription.php">Inscription</a>
                    </li>
                    <li class="nav-item">
                    </li>
                    <li class="nav-item">
